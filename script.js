...
const arr = [3, 7, 1, 9, 6];
const sorted = [...arr].sort((a, b) => a - b); // or => arr.slice().sort(...the rest of code)
sorted;
arr;
...
const newBook = {
  id: 6,
  title: 'Haary Potter and the Chamber of secrets',
  author: 'J. K. Rowling',
};
